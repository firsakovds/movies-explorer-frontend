  ...
  return (
    <section className="about-me" id="about-me">
      ...
      <div className="about-me__info">
        ...
        <p className="about-me__subtitle">Юный фронтенд-разработчик, 35 лет</p>
        <p className="about-me__description">
          ...
          университет ТГТУ(квалификация инженер). 10 лет программировал станки с
          чпу, токарные фрезерные, лазерные, плазменные. Станки программировать
          достаточно скучно, однообразно, поэтому решил обучиться на front-end
          разработчика. Умею ездить на велосипеде и стрелять из лука,
          одновременно(иногда даже попадаю в цель)
        </p>
        <Link
